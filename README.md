...
Modelado 3D de Personajes y Entorno: Creación de los modelos de personajes y gatos, siendo los 12 agentes de soporte en la base. Modelado de elementos del escenario (árboles, rocas del puzle de presión, cuencos de comida, camas).
